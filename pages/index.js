...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Shopomore.com-let shop more</title>
        <meta name="description" content="Shopomore.com-let shop more" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div>
        <img src='/logo.jpeg' alt='home' className='w-[100vw] m-auto py-2 mx-2-px-2' />
      </div>
      <>
